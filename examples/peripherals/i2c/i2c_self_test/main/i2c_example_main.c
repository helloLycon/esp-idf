...
#define DATA_LENGTH (16*1024)                  /*!< Data buffer length of test buffer */
...
//生成校验码
u16 GetSum(const u8 * charBF,int Len)
{
	u32 Sum = 0;
	u32 i ;
	for(i = 0;i < Len;i++)
...
void set_checksum(unsigned char *data, int len) {
    *(unsigned short *)(data+len) = htons(GetSum(data, len));
}
...
void app_main()
{
    ...
    uint8_t *data_wr = (uint8_t *)malloc(DATA_LENGTH);
    uint8_t *data_rd = (uint8_t *)malloc(DATA_LENGTH);
    if(NULL == data_wr || NULL == data_rd) {
        ESP_LOGE(TAG, "malloc() failed");
        return;
    }
    const char *content_string = ""\
    ...
    ""\
    "";
    strcpy((void *)data_wr, hdr);
    *(unsigned short *)(data_wr+strlen(hdr)) = htons(strlen(content_string));
    void *data_location = data_wr + strlen(hdr) + sizeof(unsigned short);
    memcpy(data_location, content_string, strlen(content_string));
    set_checksum(data_location, strlen(content_string));
    for(;;) {
        int ret = i2c_slave_read_buffer(I2C_SLAVE_NUM, data_rd, DATA_LENGTH, 1000 / portTICK_RATE_MS);
        if(ret >= 0) {
            printf("[%d] ", ret);
            if(ret) {
                static int content_sum = 0;
                i2c_slave_write_buffer(I2C_SLAVE_NUM, data_wr, strlen(hdr) + sizeof(short) + strlen(content_string) + sizeof(short), 5000 / portTICK_RATE_MS);
                disp_buf(data_rd, ret);
                content_sum += strlen(content_string);
                printf("content_sum = %d\n", content_sum);
            } else {
                printf("\n");
            }
        }
